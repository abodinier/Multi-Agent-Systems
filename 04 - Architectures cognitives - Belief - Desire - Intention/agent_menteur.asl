...
//////////////////////////////////////////////////////////////////////////////////////////
// Implémentation du plan d'envoi des messages
...
//////////////////////////////////////////////////////////////////////////////////////////    
    ...
    -values_r(I, _, _, _);
    +values_r(I, 0, 0, NUMBER_OF_VISITS+1); // Ici, on s'intéresse à l'agent menteur qui renvoie une moyenne nulle pour l'anis et la bardane
...
//////////////////////////////////////////////////////////////////////////////////////////    
//Implémentation du plan test avec mensonge
...
+?find_best_region(ITERATION, I, MEAN_ANIS, MEAN_BARDANE, NUMBER_OF_VISITS)<-
    ...
    // On itère sur les croyances afin de déterminer la meilleure région selon la maximisation de la somme d'anis et de bardane
    for(values_r(I, MEAN_ANIS, MEAN_BARDANE, NUMBER_OF_VISITS)){          
        ?best_sum(BEST_SUM);
        CURRENT_SUM = MEAN_ANIS + MEAN_BARDANE;
